<template>
  <div class="sub-sort">
    ...
    <div class="check">
      <ThemeCheckbox v-model="sortParams.inventory" @change="changeCheck"
        >仅显示有货商品</ThemeCheckbox
      >
      <ThemeCheckbox v-model="sortParams.onlyDiscount" @change="changeCheck"
        >仅显示特惠商品</ThemeCheckbox
      >
    </div>
  </div>
</template>
